      ...
      <div className="min-h-screen pt-20 max-md:pt-10">
        ...
        >
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            ...
            >
              Discover our curated collection of single-panel artists. When you
              apply for our panel exhibition program, your work will be featured
              here for our growing community to appreciate and connect with.
            </motion.p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p
                  ...
                  style={{ fontFamily: fonts.body }}
                >
                  Our panel exhibition showcases exceptional single-panel
                  artists who embody the philosophy of minimalist storytelling.
                  Artists featured here represent the finest in contemporary
                  single-panel art.
                </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3
                        className="font-semibold text-[#2C1810] mb-1"
                        style={{ fontFamily: fonts.heading }}
                      >
                      ...
                      <p
                        ...
                        style={{ fontFamily: fonts.body }}
                      >
                        Apply through our panel application section with your
                        best single-panel work
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p
                        ...
                        style={{ fontFamily: fonts.body }}
                      >
                        Our team reviews submissions for artistic quality,
                        originality, and alignment with our philosophy
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p
                        ...
                        style={{ fontFamily: fonts.body }}
                      >
                        Selected artists are featured permanently in our panel
                        exhibition with ongoing exposure
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <motion.button
                ...
                onClick={() => {
                  document
                    .querySelector("#panel-application")

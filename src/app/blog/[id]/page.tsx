    ...
    return (
      <div className="min-h-screen pt-20 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-[#2C1810] mb-4">Blog Post Not Found</h1>
          <button 
      ...
      <div className="min-h-screen pt-20">
        ...
        <section className="relative py-16 px-4 sm:px-6 overflow-hidden">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            <motion.div
              className="bg-white/15 backdrop-blur-lg border border-white/30 rounded-3xl p-8 sm:p-12 shadow-2xl"
            ...
            >
              ...
              <motion.button
                onClick={() => router.back()}
                className="flex items-center space-x-2 text-white/90 hover:text-white mb-8 transition-colors group"
                whileHover={{ x: -5 }}
              >
                <ArrowLeft className="w-5 h-5 group-hover:scale-110 transition-transform" />
                <span style={{ fontFamily: fonts.body }} className="font-medium">
                  Back to Blog
                </span>
              </motion.button>
              ...
              >
                <span className="inline-flex items-center space-x-2 bg-[#8B2635]/90 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-medium">
              ...
              {/* Title */}
              <motion.h1
                className="text-3xl sm:text-4xl lg:text-6xl font-bold mb-8 text-white leading-tight"
              ...
              {/* Meta Information */}
              <motion.div
                className="flex flex-wrap items-center gap-8 text-white/90 mb-8"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <motion.button
                  onClick={handleShare}
                  className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full hover:bg-white/20 transition-all duration-300"
              ...
              {/* Excerpt */}
              <motion.p
                className="text-xl text-white/95 leading-relaxed font-medium"
        ...
        >
          <div className="max-w-4xl mx-auto">
            <motion.article
              className="bg-white/80 backdrop-blur-sm border border-white/30 rounded-3xl p-8 sm:p-12 lg:p-16 shadow-xl"
              initial={{ opacity: 0, y: 30 }}
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="bg-gradient-to-br from-[#8B2635]/10 via-[#D4A574]/10 to-[#8B2635]/5 backdrop-blur-sm border border-[#8B2635]/20 rounded-3xl p-8 lg:p-12">
                <div className="text-center">
                  <h3
                    className="text-3xl font-bold mb-6 text-[#2C1810]"
                    style={{ fontFamily: fonts.heading }}
                  >
                  ...
                  >
                    ...
                    Connect with fellow artists who believe in the power of minimalist storytelling.
                  </p>

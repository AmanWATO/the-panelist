        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <section>
              ...
              <div className="space-y-4">
                <p className="text-lg leading-relaxed">
                  <strong>Personal Information:</strong> When you register or submit art, we may collect your name, email address, and artist profile information.
                </p>
                <p className="text-lg leading-relaxed">
                  <strong>Usage Data:</strong> We collect information about how you interact with our platform, including pages visited, time spent, and engagement patterns.
                </p>
                <p className="text-lg leading-relaxed">
                  <strong>Cookies:</strong> We use cookies to improve your experience and understand platform usage patterns.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <p className="text-lg leading-relaxed">
                  We do not sell, trade, or otherwise transfer your personal information to third parties except in these circumstances:
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              ...
              <p className="text-lg leading-relaxed mb-4">
                Our platform is not directed to children under 13 years of age. We do not knowingly collect personal information from children under 13. If you become aware that a child has provided us with personal information, please contact us immediately.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-lg leading-relaxed">
                ...
                <br />
                <strong>privacy@thepanelist.com</strong>
                <br />
                <br />
                For data protection inquiries in the EU, please contact our Data Protection Officer at:
                <br />
                <strong>dpo@thepanelist.com</strong>
              </p>
            </section>
          </motion.div>
        </div>

...
const EarlyAccessForm: React.FC<EarlyAccessFormProps> = ({ isOpen, onClose }) => {
              ...
              <>
                ...
                <div className="text-center mb-6">
                  ...
                  <p
                    ...
                    style={{ fontFamily: fonts.body }}
                  >
                    Be the first to know when we launch and get exclusive access to our community.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#8B2635] focus:border-transparent"
                      style={{ fontFamily: fonts.body }}
                      required
                    />
                  </div>
                  ...
                  <motion.button
                    ...
                    className="w-full bg-gradient-to-r from-[#8B2635] to-[#A52A3A] text-white py-3 rounded-xl font-medium hover:shadow-lg transition-all duration-300 disabled:opacity-50"
                    style={{ fontFamily: fonts.button }}

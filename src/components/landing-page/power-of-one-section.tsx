  ...
  const features = [
    {
      ...
      desc: "A single moment that lingers in memory",
    },
    {
      icon: Heart,
      title: "Interpretive Richness",
      desc: "Layers of meaning in minimal space",
    },
    {
      icon: Sparkles,
      title: "Artistic Restraint",
      desc: "The superpower of saying more with less",
    },
  ];
      ...
      <div className="max-w-6xl max-md:w-ull mx-auto">
        ...
        >
          ...
          >
            ...
            frame lingers longer in the mind than ten thousand pixels in motion.
          </p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3
                className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-[#1E1E1E]"
                style={{ fontFamily: fonts.heading }}
              >
                {feature.title}
              </h3>
        ...
        >
          <blockquote
            className="text-3xl md:text-4xl italic text-[#6E1A2C] max-w-4xl mx-auto"
            style={{ fontFamily: fonts.heading }}
          >
